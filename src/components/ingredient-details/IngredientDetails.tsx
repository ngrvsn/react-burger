...
const IngredientDetails: FC = () => {
  ...
  const modalIngredient = useSelector(
    (state: { modalItem: TIngedientModalState }) =>
      state.modalItem.modalIngredient
  );
  ...
  const [selectedIngredient, setSelectedIngredient] =
    useState<TIngredientProps | null>(null);
  /* eslint-enable */
