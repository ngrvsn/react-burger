    ...
    <div className={styles.app}>
      ...
      <Routes location={state?.backgroundLocation || location}>
        <Route
          path="/register"
          element={
            <ProtectedRouteElement element={<RegisterPage />} noNeedAuth />
          }
        />
        <Route
          path="/login"
          element={<ProtectedRouteElement element={<LoginPage />} noNeedAuth />}
        />
        <Route
        ...
        <Route
          path="/reset-password"
          element={
            <ProtectedRouteElement element={<ResetPasswordPage />} noNeedAuth />
          }
        />
